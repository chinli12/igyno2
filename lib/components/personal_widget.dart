            ...
            children: [
              ...
              FFButtonWidget(
                onPressed: () async {
                  ...
                  if (_model.heightTextController.text != null &&
                      _model.heightTextController.text != '') {
                    await currentUserReference!.update(createUsersRecordData(
                      hieght: int.tryParse(_model.heightTextController.text),
                    ));
                  } else {
                    return;
                  }

                  if (_model.weightTextController.text != null &&
                      _model.weightTextController.text != '') {
                    await currentUserReference!.update(createUsersRecordData(
                      wieght: int.tryParse(_model.weightTextController.text),
                    ));
                  } else {
                    return;
                  }
